...
namespace PlayQ.UITestTools
{
    ...
    public class UITestUserFlowRecorderController
    {
        ...
        public UITestUserFlowRecorderController()
        {
        ...
        public void HandleGameObject(GameObject go)
        {
            userFlowModel.HandleGameObject(go);
        }
        ...
        {
            GeneratedCode = userFlowModel.GeneratedCode();
            CopyToBuffer();
        }
